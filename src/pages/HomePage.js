        ...
        <div className="container px-5 py-16 mx-auto">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a href="https://www.kluniversity.in/BScHM/contact.aspx" className="text-indigo-500 block mb-2" style={{ textDecoration: 'none' }}>Click Here to Email Us</a>
            </div>
            <div className="w-full flex justify-center mt-4">
              ...
              <a href="https://www.kluniversity.in/BScHM/contact.aspx" target="_blank" rel="noopener noreferrer">
                <img src="https://cdn-icons-png.flaticon.com/128/10829/10829119.png" className="w-12 h-12 mx-2" alt="Social Media 3" />
              </a>
              <a href="https://x.com/KLUniversity?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" rel="noopener noreferrer">
